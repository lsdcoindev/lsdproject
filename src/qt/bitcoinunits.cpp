...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LSD");
    case mBTC: return QString("mLSD");
    case uBTC: return QString::fromUtf8("μLSD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LSDCoins"));
    case mBTC: return QString(QObject::tr("Milli-LSDCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LSDCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
